...
public final class QueryUtils {
    ...
    private QueryUtils() {
      ...
      // Helper Methods to implement Async task ---------------------->
  ...
  //------------------------------------------------------------------------------------------>
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject jsonRootobject = new JSONObject(earthquakeJSON);                                 //Parsing the Json and getting the required needs of the app
    ...
    // Now we will tie all the helper methods and parsing json method together ----------------------->
